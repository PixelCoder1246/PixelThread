...
├── createdAPIs.md   # Comprehensive documentation of all 108 API endpoints
└── package.json     # Root workspace configuration
```

## Key Files to Reference
- **API Documentation**: Always check `createdAPIs.md` at the project root for the latest REST API endpoints (108 total — Auth, Posts, SEO, Users, Analytics, Comments, Likes, Tags, AI, Notifications, Follow, Search, Bookmarks, Reading History, Reports, Settings, Media), request/response structures, and authentication requirements.
- **Architecture & Design**: Check the `docs/` folder for `architecture.md`, `ai-design.md`, and `setup.md`.
- **Database Schema**: Located in `server/prisma/schema.prisma` (19 models + 10 enums).
